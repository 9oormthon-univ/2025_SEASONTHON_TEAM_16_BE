...
public class HandwritingAnalysisService {
    ...
    private String createAnalysisPrompt() {
        return """
              이 이미지 속 한국어 손글씨를 분석해서 다음 3가지 기준으로 점수를 매겨주세요:

              1. 정렬 (0-33점): 글자들이 일정한 베이스라인 위에 정렬되어 있는가?
              2. 간격 (0-33점): 글자와 글자 사이의 간격이 일정하고 적절한가?
              3. 일관성 (0-34점): 글자들의 크기가 균등하고 일관된가?
...

              {
                ...
                "detailedAnalysis": "각 항목별 상세한 분석 내용"
              }
              """;
    }
