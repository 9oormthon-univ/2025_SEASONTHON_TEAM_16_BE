...
@Tag(name = "Gallery", description = "필사 갤러리 API")
public class GalleryController {

    private final GalleryService galleryService;

    @GetMapping
    @Operation(summary = "갤러리 목록 조회", description = "사용자의 필사 갤러리를 기간별,점수별로 필터링하여 페이징 조회합니다.")
    ...
    @Operation(summary = "갤러리 상세 조회", description = "특정 갤러리 항목의 상세 정보(점수, 피드백, 분석 결과)를 조회합니다.")
